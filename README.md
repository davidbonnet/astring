...
- Considerably faster than [UglifyJS](https://github.com/mishoo/UglifyJS2) (up to 100×), [Escodegen](https://github.com/estools/escodegen) (up to 10×), [Esast](https://github.com/mason-lang/esast) (up to 10×) and [Esotope](https://github.com/inikulin/esotope) (up to 3×).
- No dependencies and small footprint (≈ 15 KB minified, ≈ 4 KB gziped).
